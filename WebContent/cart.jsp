	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${cart.cartitems}" var="entry">
								...
								<td width="15%">
									<span class="subtotal">￥${entry.value.totalPrice}</span>
								</td>
								<td>
			...
			<div style="margin-right:130px;">
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
			</em> 赠送积分: <em style="color:#ff6600;">${cart.bonus}</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥${cart.bonus}</strong>
				</div>
			...
			<c:if test="${empty cart.cartitems}">
					<div style="width:800px;margin:0 auto;text-align:center">
						<img src="${pageContext.request.contextPath}/img/cart-empty.png" alt=""/>
