	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${pagebean.list}" var="pro">
			<div class="col-md-2" style="height:250px;">
				...
				<p>
					<a href="${pageContext.request.contextPath}/product?method=productInfo&cid=${cid}&currentPage=${pagebean.currentPage}" style='color: green'>${pro.pname}</a>
				</p>
				<p>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:forEach begin="1" end="${pagebean.totalPage}" var="page">
				...
				<c:if test="${page!=pagebean.currentPage}">
					<li class><a href="${pageContext.request.contextPath}/product?method=productListByCid&cid=${cid}&currentPage=${page}">${page}</a></li>
				</c:if>
			</c:forEach>
	...
	<div
		...
		<div style="overflow: hidden;">
			...
			<ul style="list-style: none;">
				<c:forEach items="${historyList}" var="product">
				<li
